                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center gap-4 md:gap-6">
                                                <div className="size-10 md:size-14 bg-white/5 rounded-xl md:rounded-2xl flex items-center justify-center group-hover:bg-[#f2b90d]/10 group-hover:text-[#f2b90d] transition-all">
                                            ...
                                            <div className="flex items-center justify-between sm:justify-end gap-3 md:gap-4">
                                                {selectedCount > 0 && (
                                                    <div className="bg-[#f2b90d] text-black px-3 py-1 rounded-full text-[8px] md:text-[10px] font-black uppercase italic whitespace-nowrap">
