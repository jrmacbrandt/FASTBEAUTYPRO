            ...
            <main className="relative z-10 max-w-4xl mx-auto px-6 pt-12 pb-24 min-h-[calc(100vh-100px)] flex flex-col justify-center">
                {step > 1 && step < 6 && (
                    <button
                        ...
                        className="fixed left-6 md:left-[calc((100vw-56rem)/2+1.5rem)] top-[120px] md:top-[130px] size-10 flex items-center justify-center rounded-full hover:opacity-80 transition-all group z-[100] cursor-pointer"
